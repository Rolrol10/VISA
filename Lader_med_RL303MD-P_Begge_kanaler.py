...
if __name__ == "__main__":
    ...
    channel_right_done = False
    channel_left_done = False
    ...
    while looptiloop:
        ...
        if current_left < cutoff_c:
            ...
            channel_left_done = True
            # break

        if (channel_left_done and channel_right_done):
            print("Charging done on both channels: ")
            break
